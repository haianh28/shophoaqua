...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href='<c:out value="${pageContext.request.contextPath}/resource/Css/bootstrap.min.css"/>'>
<!-- Custom CSS -->
<link rel="stylesheet" href='<c:out value="${pageContext.request.contextPath}/resource/Css/style.css"/>'>
<link rel="stylesheet" href='<c:out value="${pageContext.request.contextPath}/resource/Css/morris.css"/>'>
<!-- Graph CSS -->
<link rel="stylesheet" href='<c:out value="${pageContext.request.contextPath}/resource/Css/font-awesome.css"/>'>
<!-- jQuery -->
<script src='<c:out value="${pageContext.request.contextPath}/resource/JavaScript/jquery-3.4.1.min.js"/>'></script>
<!-- //jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link rel="stylesheet" href='<c:out value="${pageContext.request.contextPath}/resource/Css/icon-font.min.css"/>'>
<!-- //lined-icons -->
</head> 
<body>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href='<c:out value="${pageContext.request.contextPath}/Dashboard"/>'><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>	
										
										 <li id="menu-academico" ><a href='<c:out value="${pageContext.request.contextPath}/ThemSanPham"/>'><i class="fa fa-product-hunt nav_icon"></i><span>Sản Phẩm</span><div class="clearfix"></div></a></li>
...
<!--js -->
<script src='<c:out value="${pageContext.request.contextPath}/resource/JavaScript/jquery.nicescroll.js"/>'></script>
<script src='<c:out value="${pageContext.request.contextPath}/resource/JavaScript/scripts.js"/>'></script>
<!-- Bootstrap Core JavaScript -->
<script src='<c:out value="${pageContext.request.contextPath}/resource/JavaScript/bootstrap.min.js"/>'></script>
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src='<c:out value="${pageContext.request.contextPath}/resource/JavaScript/raphael-min.js"/>'></script>
<script src='<c:out value="${pageContext.request.contextPath}/resource/JavaScript/morris.js"/>'></script>
<script>
	$(document).ready(function() {
